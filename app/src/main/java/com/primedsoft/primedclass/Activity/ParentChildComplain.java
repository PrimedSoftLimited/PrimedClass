...
public class ParentChildComplain extends AppCompatActivity {
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_child_complain);
    ...
    private void initAdapter() {
        FirebaseRecyclerAdapter<ComplainModel, AllParent> adapter = new FirebaseRecyclerAdapter<ComplainModel, AllParent>(
            ...
            protected void populateViewHolder(AllParent viewHolder, ComplainModel model, int position) {
                ...
                if (model.getParentUid().equalsIgnoreCase(uid)){
                    if (model.getChildKey().equalsIgnoreCase(childKey)){
                                        ...
                                        if (dataSnapshot.exists()) {
                                            ...
                                            viewHolder.address.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    viewHolder.address.setEnabled(false);
                                                    Toast.makeText(ParentChildComplain.this, "Resolving complain..please wait", Toast.LENGTH_SHORT).show();
                                                    complainRef.child("resolved").setValue("yes")
                                                        ...
                                                        public void onFailure(@NonNull Exception e) {
                                                            viewHolder.address.setEnabled(true);
                                                            Toast.makeText(ParentChildComplain.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                                }
                                            });
